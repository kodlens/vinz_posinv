            ...
            <div class="columns is-centered">
                <div class="column is-6-desktop is-8-tablet">
                    <div class="box">
                        ...
                        <div class="is-flex is-justify-content-center mb-2" style="font-size: 20px; font-weight: bold;">INVENTORY LIST</div>
        ...
        */
        loadAsyncData() {
            const params = [
                ...
                `item=${this.search.itemname}`,
                `perpage=${this.perPage}`,
                `page=${this.page}`
            ].join('&')

            this.loading = true
            axios.get(`/get-inventories?${params}`)
                .then(({ data }) => {
                    this.data = [];
